        ...
        fetch(`${routes.cart_add_url}`, config)
          ...
          .then((response) => {
            if (response.status) {
              ...
              linesUpdateDeferred?.reject(
                new Error(response.description || response.message),
              );
      ...
      resolveCartLinesUpdate(deferred) {
        ...
        const pendingCartDataPromise =
          typeof CartItems !== "undefined"
            ...
            : fetch(`${routes.cart_url}.json`).then((response) =>
                response.json(),
              );
          ...
          .then((cart) => {
            if (!cart?.currency)
              return deferred.reject(
                new Error("Missing currency in cart response"),
              );
            deferred.resolve({
